...
CREATE TABLE IF NOT EXISTS `blogs` (
  ...
  `view_count` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '0 create 1 publish 2 not publish',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `blogs` (`id`, `title`, `slug`, `image`, `body`, `user_id`, `view_count`, `status`, `created_at`, `updated_at`) VALUES
(1, 'ایام نامزدی و اشتباهات رایج ویرایش شده', 'engagement-days-and-common-mistakes', 'blog/images/20_12_30_12_35_17_457.PNG', 'در کشور ما از دیرباز تاکنون، بسیاری از خانواده‌ها به صورت سنتی و عامیانه، پیش از عقد رسمی، زوجین را با صیغه‌ای موقت و فی‌المجلس تحت عنوان نامزدی، حالا  به جهت آشنایی بیشتر یا به دلیل انجام مقدمات ازدواج با این تصور که احیانا در صورت وجود ارتباط جسمی و حتی جنسی از لحاظ شرعی رابطه‌ی ایشان صحیح باشد، با مقدار ناچیزی مهریه بر یکدیگر محرم می‌کنند، با این نیت که پس از اتمام این دوره، طرفین به عقد نکاح دائم اقدام نمایند؛ لکن این امر همه ساله مشکلات ناخواسته‌ی بسیاری را در روابط زوجین، خانواده‌ی ایشان و همچنین در مورد آینده‌ی طرفین ایجاد می‌کند.\n\nدر این موارد، پس از اتمام مدت زمان نکاح موقت یا در طول این مدت، ممکن است هریک از طرفین به هر دلیلی از پذیرفتن مسؤلیت ازدواج و زندگی مشترک با طرف مقابل سر باز زده یا راضی به عقد دائم نشوند، یا زوج به هر علتی از اقدام برای نکاح دائم خودداری ورزد.\n\nدر این هنگام است که جرقه‌ای از عدم آگاهی نسبت به حقوق و نیز درک درست از وضعیت موجود که در ابتدای امر توسط والدین و به دلایل نه چندان منطقی زده شده بود، شعله‌ور شده و تمام رویاها، انگیزه‌ها و اهداف طرفین را به کام حریقی گسترده می‌کشاند.\n\nالبته در این موارد زوجه دچار تضرر روحی، جسمی و عاطفی بیشتری خواهد شد، چرا که به دلیل شرعی بودن روابط، نیز غلیان احساسات و تمایلات درونی، چه بسا مرتکب روابط زناشویی شده و سبب زوال باکرگی وی فراهم گردد. \n\nدر این حین به دلیل عدم تطابق ازاله بکارت با ماده ١١٠٠ قانون مدنی، به‌خاطر معین بودن میزان مهریه، حتی نمی‌توان درخواست دریافت مهرالمثل یا ارش‌البکاره نمود، چرا که این عقد از هر جهت صحیح و منطبق بر احکام شرعی و قانونی بوده است.\n\nلذا با تمام سختی‌ها و جریحه‌دار شدن احساسات و عواطف زوجه، ایشان تنها مستحق دریافت همان مقدار ناچیز قید شده به عنوان مهر خواهند بود و از طرفی به دلیل عدم ثبت این واقعه در شناسنامه و دفاتر رسمی ازدواج، زوجه در صورت ازدواج مجدد نیز قطعا دچار لطمات و دشواری‌های فراوانی خواهد شد؛ چرا که زوج در عقد نکاح موقت مطابق با ماده ٢٢ لایحه حمایت از خانواده، تنها در سه صورت ملزم به ثبت واقعه‌ی نکاح موقت خواهد بود که این موارد عبارتند از:\n\nباردار شدن زوجه\nتوافق طرفین\nشرط ضمن عقد مبنی بر ثبت نکاح موقت. \nاما آیا راهی برای اطمینان و جلوگیری از این قبیل مسائل پیش از رسمی و دائمی شدن عقد نکاح وجود دارد؟ \n\nدر پاسخ باید گفت با توجه به دقت، ظرافت و نیز گستردگی و پیشرفت علم روانشناسی، توصیه می‌شود والدین با مشارکت و حضور یکدیگر زوج و زوجه را جهت بررسی و مشاوره‌ی پیش از ازدواج، نزد روانشناسی معتبر و امین همراهی نمایند.\n\nلذا بعد از گذراندن مرحله فوق چنانچه نظریه مشاور نیز صلاح را در تزویج طرفین دید، در اولین فرصت با فرض مهریه کامل و در شأن زوجه به عقد دائم و رسمی زوج درآورند و یا حتی‌الامکان در زمان کوتاه نامزدی قبل از ثبت و رسمی شدن نکاح، با اعمال شیوه‌های مختلف متناسب با فرهنگ خود، مراقبت بیشتری از فرزندان نمایند، تا ایشان نیز در آسودگی و ورای دغدغه‌های غیرقابل پیش‌بینی زندگی خود را آغاز نمایند.', 2, '0', '0', '2020-12-30 08:41:39', '2020-12-30 09:05:17'),
(2, 'ایام نامزدی و اشتباهات رایج', 'engagement-days-and-common-mi54545', 'default.png', 'در کشور ما از دیرباز تاکنون، بسیاری از خانواده‌ها به صورت سنتی و عامیانه، پیش از عقد رسمی، زوجین را با صیغه‌ای موقت و فی‌المجلس تحت عنوان نامزدی، حالا  به جهت آشنایی بیشتر یا به دلیل انجام مقدمات ازدواج با این تصور که احیانا در صورت وجود ارتباط جسمی و حتی جنسی از لحاظ شرعی رابطه‌ی ایشان صحیح باشد، با مقدار ناچیزی مهریه بر یکدیگر محرم می‌کنند، با این نیت که پس از اتمام این دوره، طرفین به عقد نکاح دائم اقدام نمایند؛ لکن این امر همه ساله مشکلات ناخواسته‌ی بسیاری را در روابط زوجین، خانواده‌ی ایشان و همچنین در مورد آینده‌ی طرفین ایجاد می‌کند.\r\n\r\nدر این موارد، پس از اتمام مدت زمان نکاح موقت یا در طول این مدت، ممکن است هریک از طرفین به هر دلیلی از پذیرفتن مسؤلیت ازدواج و زندگی مشترک با طرف مقابل سر باز زده یا راضی به عقد دائم نشوند، یا زوج به هر علتی از اقدام برای نکاح دائم خودداری ورزد.\r\n\r\nدر این هنگام است که جرقه‌ای از عدم آگاهی نسبت به حقوق و نیز درک درست از وضعیت موجود که در ابتدای امر توسط والدین و به دلایل نه چندان منطقی زده شده بود، شعله‌ور شده و تمام رویاها، انگیزه‌ها و اهداف طرفین را به کام حریقی گسترده می‌کشاند.\r\n\r\nالبته در این موارد زوجه دچار تضرر روحی، جسمی و عاطفی بیشتری خواهد شد، چرا که به دلیل شرعی بودن روابط، نیز غلیان احساسات و تمایلات درونی، چه بسا مرتکب روابط زناشویی شده و سبب زوال باکرگی وی فراهم گردد. \r\n\r\nدر این حین به دلیل عدم تطابق ازاله بکارت با ماده ١١٠٠ قانون مدنی، به‌خاطر معین بودن میزان مهریه، حتی نمی‌توان درخواست دریافت مهرالمثل یا ارش‌البکاره نمود، چرا که این عقد از هر جهت صحیح و منطبق بر احکام شرعی و قانونی بوده است.\r\n\r\nلذا با تمام سختی‌ها و جریحه‌دار شدن احساسات و عواطف زوجه، ایشان تنها مستحق دریافت همان مقدار ناچیز قید شده به عنوان مهر خواهند بود و از طرفی به دلیل عدم ثبت این واقعه در شناسنامه و دفاتر رسمی ازدواج، زوجه در صورت ازدواج مجدد نیز قطعا دچار لطمات و دشواری‌های فراوانی خواهد شد؛ چرا که زوج در عقد نکاح موقت مطابق با ماده ٢٢ لایحه حمایت از خانواده، تنها در سه صورت ملزم به ثبت واقعه‌ی نکاح موقت خواهد بود که این موارد عبارتند از:\r\n\r\nباردار شدن زوجه\r\nتوافق طرفین\r\nشرط ضمن عقد مبنی بر ثبت نکاح موقت. \r\nاما آیا راهی برای اطمینان و جلوگیری از این قبیل مسائل پیش از رسمی و دائمی شدن عقد نکاح وجود دارد؟ \r\n\r\nدر پاسخ باید گفت با توجه به دقت، ظرافت و نیز گستردگی و پیشرفت علم روانشناسی، توصیه می‌شود والدین با مشارکت و حضور یکدیگر زوج و زوجه را جهت بررسی و مشاوره‌ی پیش از ازدواج، نزد روانشناسی معتبر و امین همراهی نمایند.\r\n\r\nلذا بعد از گذراندن مرحله فوق چنانچه نظریه مشاور نیز صلاح را در تزویج طرفین دید، در اولین فرصت با فرض مهریه کامل و در شأن زوجه به عقد دائم و رسمی زوج درآورند و یا حتی‌الامکان در زمان کوتاه نامزدی قبل از ثبت و رسمی شدن نکاح، با اعمال شیوه‌های مختلف متناسب با فرهنگ خود، مراقبت بیشتری از فرزندان نمایند، تا ایشان نیز در آسودگی و ورای دغدغه‌های غیرقابل پیش‌بینی زندگی خود را آغاز نمایند.', 5, '0', '0', '2020-12-30 08:41:39', '2020-12-30 08:41:39'),
(3, 'ایام نامزدی و اشتباهات رایج تبیالخایبخلخایبلاهیبال', 'engagement-days-and-common-mi54545-5454', 'default.png', 'در کشور ما از دیرباز تاکنون، بسیاری از خانواده‌ها به صورت سنتی و عامیانه، پیش از عقد رسمی، زوجین را با صیغه‌ای موقت و فی‌المجلس تحت عنوان نامزدی، حالا  به جهت آشنایی بیشتر یا به دلیل انجام مقدمات ازدواج با این تصور که احیانا در صورت وجود ارتباط جسمی و حتی جنسی از لحاظ شرعی رابطه‌ی ایشان صحیح باشد، با مقدار ناچیزی مهریه بر یکدیگر محرم می‌کنند، با این نیت که پس از اتمام این دوره، طرفین به عقد نکاح دائم اقدام نمایند؛ لکن این امر همه ساله مشکلات ناخواسته‌ی بسیاری را در روابط زوجین، خانواده‌ی ایشان و همچنین در مورد آینده‌ی طرفین ایجاد می‌کند.\r\n\r\nدر این موارد، پس از اتمام مدت زمان نکاح موقت یا در طول این مدت، ممکن است هریک از طرفین به هر دلیلی از پذیرفتن مسؤلیت ازدواج و زندگی مشترک با طرف مقابل سر باز زده یا راضی به عقد دائم نشوند، یا زوج به هر علتی از اقدام برای نکاح دائم خودداری ورزد.\r\n\r\nدر این هنگام است که جرقه‌ای از عدم آگاهی نسبت به حقوق و نیز درک درست از وضعیت موجود که در ابتدای امر توسط والدین و به دلایل نه چندان منطقی زده شده بود، شعله‌ور شده و تمام رویاها، انگیزه‌ها و اهداف طرفین را به کام حریقی گسترده می‌کشاند.\r\n\r\nالبته در این موارد زوجه دچار تضرر روحی، جسمی و عاطفی بیشتری خواهد شد، چرا که به دلیل شرعی بودن روابط، نیز غلیان احساسات و تمایلات درونی، چه بسا مرتکب روابط زناشویی شده و سبب زوال باکرگی وی فراهم گردد. \r\n\r\nدر این حین به دلیل عدم تطابق ازاله بکارت با ماده ١١٠٠ قانون مدنی، به‌خاطر معین بودن میزان مهریه، حتی نمی‌توان درخواست دریافت مهرالمثل یا ارش‌البکاره نمود، چرا که این عقد از هر جهت صحیح و منطبق بر احکام شرعی و قانونی بوده است.\r\n\r\nلذا با تمام سختی‌ها و جریحه‌دار شدن احساسات و عواطف زوجه، ایشان تنها مستحق دریافت همان مقدار ناچیز قید شده به عنوان مهر خواهند بود و از طرفی به دلیل عدم ثبت این واقعه در شناسنامه و دفاتر رسمی ازدواج، زوجه در صورت ازدواج مجدد نیز قطعا دچار لطمات و دشواری‌های فراوانی خواهد شد؛ چرا که زوج در عقد نکاح موقت مطابق با ماده ٢٢ لایحه حمایت از خانواده، تنها در سه صورت ملزم به ثبت واقعه‌ی نکاح موقت خواهد بود که این موارد عبارتند از:\r\n\r\nباردار شدن زوجه\r\nتوافق طرفین\r\nشرط ضمن عقد مبنی بر ثبت نکاح موقت. \r\nاما آیا راهی برای اطمینان و جلوگیری از این قبیل مسائل پیش از رسمی و دائمی شدن عقد نکاح وجود دارد؟ \r\n\r\nدر پاسخ باید گفت با توجه به دقت، ظرافت و نیز گستردگی و پیشرفت علم روانشناسی، توصیه می‌شود والدین با مشارکت و حضور یکدیگر زوج و زوجه را جهت بررسی و مشاوره‌ی پیش از ازدواج، نزد روانشناسی معتبر و امین همراهی نمایند.\r\n\r\nلذا بعد از گذراندن مرحله فوق چنانچه نظریه مشاور نیز صلاح را در تزویج طرفین دید، در اولین فرصت با فرض مهریه کامل و در شأن زوجه به عقد دائم و رسمی زوج درآورند و یا حتی‌الامکان در زمان کوتاه نامزدی قبل از ثبت و رسمی شدن نکاح، با اعمال شیوه‌های مختلف متناسب با فرهنگ خود، مراقبت بیشتری از فرزندان نمایند، تا ایشان نیز در آسودگی و ورای دغدغه‌های غیرقابل پیش‌بینی زندگی خود را آغاز نمایند.', 6, '0', '0', '2020-12-30 08:41:39', '2020-12-30 08:41:39'),
(4, 'خایبخلخایبلاهیبال', 'engagement-days-an', 'default.png', 'در کشور ما از دیرباز تاکنون، بسیاری از خانواده‌ها به صورت سنتی و عامیانه، پیش از عقد رسمی، زوجین را با صیغه‌ای موقت و فی‌المجلس تحت عنوان نامزدی، حالا  به جهت آشنایی بیشتر یا به دلیل انجام مقدمات ازدواج با این تصور که احیانا در صورت وجود ارتباط جسمی و حتی جنسی از لحاظ شرعی رابطه‌ی ایشان صحیح باشد، با مقدار ناچیزی مهریه بر یکدیگر محرم می‌کنند، با این نیت که پس از اتمام این دوره، طرفین به عقد نکاح دائم اقدام نمایند؛ لکن این امر همه ساله مشکلات ناخواسته‌ی بسیاری را در روابط زوجین، خانواده‌ی ایشان و همچنین در مورد آینده‌ی طرفین ایجاد می‌کند.\r\n\r\nدر این موارد، پس از اتمام مدت زمان نکاح موقت یا در طول این مدت، ممکن است هریک از طرفین به هر دلیلی از پذیرفتن مسؤلیت ازدواج و زندگی مشترک با طرف مقابل سر باز زده یا راضی به عقد دائم نشوند، یا زوج به هر علتی از اقدام برای نکاح دائم خودداری ورزد.\r\n\r\nدر این هنگام است که جرقه‌ای از عدم آگاهی نسبت به حقوق و نیز درک درست از وضعیت موجود که در ابتدای امر توسط والدین و به دلایل نه چندان منطقی زده شده بود، شعله‌ور شده و تمام رویاها، انگیزه‌ها و اهداف طرفین را به کام حریقی گسترده می‌کشاند.\r\n\r\nالبته در این موارد زوجه دچار تضرر روحی، جسمی و عاطفی بیشتری خواهد شد، چرا که به دلیل شرعی بودن روابط، نیز غلیان احساسات و تمایلات درونی، چه بسا مرتکب روابط زناشویی شده و سبب زوال باکرگی وی فراهم گردد. \r\n\r\nدر این حین به دلیل عدم تطابق ازاله بکارت با ماده ١١٠٠ قانون مدنی، به‌خاطر معین بودن میزان مهریه، حتی نمی‌توان درخواست دریافت مهرالمثل یا ارش‌البکاره نمود، چرا که این عقد از هر جهت صحیح و منطبق بر احکام شرعی و قانونی بوده است.\r\n\r\nلذا با تمام سختی‌ها و جریحه‌دار شدن احساسات و عواطف زوجه، ایشان تنها مستحق دریافت همان مقدار ناچیز قید شده به عنوان مهر خواهند بود و از طرفی به دلیل عدم ثبت این واقعه در شناسنامه و دفاتر رسمی ازدواج، زوجه در صورت ازدواج مجدد نیز قطعا دچار لطمات و دشواری‌های فراوانی خواهد شد؛ چرا که زوج در عقد نکاح موقت مطابق با ماده ٢٢ لایحه حمایت از خانواده، تنها در سه صورت ملزم به ثبت واقعه‌ی نکاح موقت خواهد بود که این موارد عبارتند از:\r\n\r\nباردار شدن زوجه\r\nتوافق طرفین\r\nشرط ضمن عقد مبنی بر ثبت نکاح موقت. \r\nاما آیا راهی برای اطمینان و جلوگیری از این قبیل مسائل پیش از رسمی و دائمی شدن عقد نکاح وجود دارد؟ \r\n\r\nدر پاسخ باید گفت با توجه به دقت، ظرافت و نیز گستردگی و پیشرفت علم روانشناسی، توصیه می‌شود والدین با مشارکت و حضور یکدیگر زوج و زوجه را جهت بررسی و مشاوره‌ی پیش از ازدواج، نزد روانشناسی معتبر و امین همراهی نمایند.\r\n\r\nلذا بعد از گذراندن مرحله فوق چنانچه نظریه مشاور نیز صلاح را در تزویج طرفین دید، در اولین فرصت با فرض مهریه کامل و در شأن زوجه به عقد دائم و رسمی زوج درآورند و یا حتی‌الامکان در زمان کوتاه نامزدی قبل از ثبت و رسمی شدن نکاح، با اعمال شیوه‌های مختلف متناسب با فرهنگ خود، مراقبت بیشتری از فرزندان نمایند، تا ایشان نیز در آسودگی و ورای دغدغه‌های غیرقابل پیش‌بینی زندگی خود را آغاز نمایند.', 8, '0', '0', '2020-12-30 08:41:39', '2020-12-30 08:41:39');
...
CREATE TABLE IF NOT EXISTS `lawyer_infos` (
  ...
  `sex` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '1 Male 2 Female',
...
(1, 2, '[[{\"key\": 0, \"val\": \"انحصار وراثت\"}], [{\"key\": 0, \"val\": \"انحصار فرزند\"}]]', 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی، و فرهنگ پیشرو در زبان فارسی ایجاد کرد، در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی، و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.', 'تسیارهعسیارتهخسیعارهخعسیارهعسر', '5', '127', '14', '0', '0', '0', '0', '0', '0', '0', '0', '0', 'null', 'null', '1', 'lawyer/confirmation/20_12_24_04_47_57_308.PNG', '', '', 'lawyer/confirmation/20_12_17_06_48_20_756.PNG', 'null', 'null', '2020-12-24 13:22:29', '2020-12-29 13:24:55'),
(2, 5, '[[{\"key\": 0, \"val\": \"انحصار وراثت\"}], [{\"key\": 0, \"val\": \"انحصار فرزند\"}], [{\"key\": 0, \"val\": \"انحصار وراثت\"}], [{\"key\": 0, \"val\": \"انحصار فرزند\"}]]', 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی، و فرهنگ پیشرو در زبان فارسی ایجاد کرد، در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی، و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.', 'قلتثقه0تلخثهقتالخثهقل', '4', '20', '10', '0', '0', '0', '0', '0', '0', '0', '0', '0', 'null', 'null', '1', 'lawyer/confirmation/20_12_24_04_47_57_308.PNG', '', '', 'lawyer/confirmation/20_12_17_06_48_20_756.PNG', 'null', 'null', '2020-12-24 13:22:29', '2020-12-29 13:24:55'),
(3, 6, '[[{\"key\": 0, \"val\": \"انحصار وراثت\"}], [{\"key\": 0, \"val\": \"انحصار فرزند\"}], [{\"key\": 0, \"val\": \"انحصار وراثت\"}], [{\"key\": 0, \"val\": \"انحصار فرزند\"}], [{\"key\": 0, \"val\": \"انحصار وراثت\"}], [{\"key\": 0, \"val\": \"انحصار فرزند\"}]]', 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی، و فرهنگ پیشرو در زبان فارسی ایجاد کرد، در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی، و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.', 'یج0لرهیس09بعی0سخب', '4.5', '15', '5', '0', '0', '0', '0', '0', '0', '0', '0', '0', 'null', 'null', '1', 'lawyer/confirmation/20_12_24_04_47_57_308.PNG', '', '', 'lawyer/confirmation/20_12_17_06_48_20_756.PNG', 'null', 'null', '2020-12-24 13:22:29', '2020-12-29 13:24:55'),
(4, 8, '[[{\"key\": 0, \"val\": \"انحصار وراثت\"}], [{\"key\": 0, \"val\": \"انحصار فرزند\"}], [{\"key\": 0, \"val\": \"انحصار وراثت\"}], [{\"key\": 0, \"val\": \"انحصار فرزند\"}], [{\"key\": 0, \"val\": \"انحصار وراثت\"}], [{\"key\": 0, \"val\": \"انحصار فرزند\"}], [{\"key\": 0, \"val\": \"انحصار وراثت\"}], [{\"key\": 0, \"val\": \"انحصار فرزند\"}]]', 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی، و فرهنگ پیشرو در زبان فارسی ایجاد کرد، در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی، و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.', 'بختهحصثا87بغاصثبلغ8صثبصثبصثبصثب', '1', '14', '13', '0', '0', '0', '0', '0', '0', '0', '0', '0', 'null', 'null', '1', 'lawyer/confirmation/20_12_24_04_47_57_308.PNG', '', '', 'lawyer/confirmation/20_12_17_06_48_20_756.PNG', 'null', 'null', '2020-12-24 13:22:29', '2020-12-29 13:24:55');
...
CREATE TABLE IF NOT EXISTS `roles` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` int(11) NOT NULL DEFAULT '2' COMMENT '1 user 2 Lawyers 3 admin 4 user_admin',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'کاربر', 1, NULL, NULL),
(2, 'وکیل', 2, NULL, NULL),
(3, 'کارشناس حقوقی', 2, NULL, NULL),
(4, 'کار آموز وکالت', 2, NULL, NULL);
